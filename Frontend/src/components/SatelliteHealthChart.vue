    ...
    <div class="bg-slate-50 rounded-xl overflow-hidden">
      <div class="max-h-48 overflow-y-auto">
        <TransitionGroup name="satellite-list" tag="div" class="space-y-0 p-0.5">
          <div v-for="sat in sortedSatellites"
            ...
            <div class="flex-1 relative">
              <div class="h-4 bg-slate-200 rounded-full overflow-hidden">
                <div class="h-full bg-gradient-to-r rounded-full transition-all duration-300"
                     :class="[
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <span class="font-mono font-semibold text-xs text-white drop-shadow-sm"
