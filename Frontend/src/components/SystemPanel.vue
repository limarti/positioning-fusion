    ...
    <Card title="Device Name"
      ...
      <div class="space-y-4">
        ...
        <div class="flex space-x-2">
          <div class="flex-1">
            <input v-model="systemState.editedHostname"
                   type="text"
          ...
          <div v-if="systemState.isHostnameModified" class="flex space-x-2">
            <button :disabled="systemState.isUpdatingHostname || !systemState.editedHostname || !systemState.editedHostname.trim() || !systemState.isHostnameValid"
            ...
            <button :disabled="systemState.isUpdatingHostname"
