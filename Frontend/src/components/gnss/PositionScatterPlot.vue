  ...
  <Card title="Position Plot"
    ...
    <div class="flex flex-wrap items-center gap-3 mb-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
      ...
      <div class="flex items-center space-x-2">
        ...
        <input v-model="autoRangeEnabled"
               type="checkbox"
               class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 rounded focus:ring-gray-500 focus:ring-2">
      </div>
      
      <div class="flex items-center space-x-1">
        <button class="w-8 h-8 flex items-center justify-center text-sm bg-gray-600 text-white rounded hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500"
      ...
      <button class="px-3 py-1 text-sm bg-gray-500 text-white rounded hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500"
              :disabled="positionHistory.length === 0"
              @click="reset">
        Reset
      </button>

      <button class="px-3 py-1 text-sm bg-gray-700 text-white rounded hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500"
              :disabled="positionHistory.length === 0"
              @click="clearHistory">
        Clear
      </button>
