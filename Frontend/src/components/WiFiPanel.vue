  ...
  <div class="main-container">
      ...
      <div class="panel-content">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex items-center space-x-2">
            <div class="w-2 h-2 rounded-full" :class="wifiState.wifiStatus.isConnected ? 'bg-gray-900' : 'bg-gray-400'"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div v-if="wifiState.wifiStatus.connectedNetworkSSID" class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="text-sm font-semibold text-gray-900 truncate">{{ wifiState.wifiStatus.connectedNetworkSSID }}</div>
          </div>
          ...
          <div v-if="wifiState.wifiStatus.signalStrength" class="bg-gray-50 rounded-lg p-4">
            ...
            <div class="flex items-center space-x-2">
              <div class="text-sm font-semibold text-gray-900">{{ wifiState.wifiStatus.signalStrength }}%</div>
              <div class="flex space-x-1">
                <div class="w-1 h-3 rounded-full" :class="wifiState.wifiStatus.signalStrength >= 25 ? 'bg-gray-900' : 'bg-gray-300'"></div>
                <div class="w-1 h-3 rounded-full" :class="wifiState.wifiStatus.signalStrength >= 50 ? 'bg-gray-900' : 'bg-gray-300'"></div>
                <div class="w-1 h-3 rounded-full" :class="wifiState.wifiStatus.signalStrength >= 75 ? 'bg-gray-900' : 'bg-gray-300'"></div>
                <div class="w-1 h-3 rounded-full" :class="wifiState.wifiStatus.signalStrength >= 90 ? 'bg-gray-900' : 'bg-gray-300'"></div>
              </div>
            </div>
          </div>
        ...
        <div v-else class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label class="relative cursor-pointer">
              <input
                v-model="wifiState.preferredMode"
                type="radio"
                value="Client"
              ...
              <div class="p-4 rounded-lg border-2 transition-all duration-200"
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
                    ...
                    <div v-if="wifiState.preferredMode === 'Client'" class="w-2 h-2 rounded-full bg-gray-900"></div>
                  </div>
                </div>
              </div>
            </label>
              ...
              <div class="p-4 rounded-lg border-2 transition-all duration-200"
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
                    ...
                    <div v-if="wifiState.preferredMode === 'AP'" class="w-2 h-2 rounded-full bg-gray-900"></div>
                  </div>
                </div>
              </div>
            </label>
          ...
          <div class="space-y-4 pt-4 border-t border-gray-200">
            ...
            <div>
              ...
              <div class="relative">
                <input
                  v-model="wifiState.apConfig.password"
    ...
    <div class="panel">
      ...
      <div v-if="wifiState.knownNetworks.length > 0" class="divide-y divide-gray-100">
        <div
          v-for="network in wifiState.knownNetworks"
          :key="network.ssid"
          class="px-6 py-4"
        >
          <div class="flex items-center justify-between">
      ...
      <div class="relative bg-white border border-gray-200 rounded-lg shadow-xl max-w-md w-full max-h-screen overflow-y-auto">
        ...
        <div class="px-6 py-5 space-y-4">
          <div>
            ...
            <input
              v-model="wifiState.dialogNetworkConfig.ssid"
              type="text"
          ...
          <div>
            ...
            <div class="relative">
              <input
                v-model="wifiState.dialogNetworkConfig.password"
        ...
        <div class="px-6 py-4 border-t border-gray-100 flex justify-end space-x-3">
          ...
          <button
            @click="addNetwork"
            :disabled="wifiState.isConnecting || !wifiState.dialogNetworkConfig.ssid || !wifiState.dialogNetworkConfig.password"
            class="btn-primary"
          >
